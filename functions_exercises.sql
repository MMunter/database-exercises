...
select concat(first_name, ' ', last_name, ' has worked here for ', datediff(now(), hire_date), ' days.') from employees where birth_date like '%-12-25' and hire_date BETWEEN '1990-01-01' and '1999-12-31'
